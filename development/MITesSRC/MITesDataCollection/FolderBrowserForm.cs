...
namespace OpenNETCF.Windows.Forms
{
	...
	internal class FolderBrowserForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.mnuMenu.Text = "Cancel";
            this.mnuMenu.Click+= new System.EventHandler(this.mnuCancel_Click);
			// 
			// mnuNew
			// 
		...
		public FolderBrowserForm()
		{
			...
			ilIcons.Images.Add(new System.Drawing.Bitmap(MITesDataCollection.Resource1.Folder));

#if (PocketPC)
            ilIcons.Images.Add(new System.Drawing.Bitmap(MITesDataCollection.Resource1.Device));
#else
            ilIcons.Images.Add(new System.Drawing.Bitmap(MITesDataCollection.Resource1.PC));
#endif
			ilIcons.Images.Add(new System.Drawing.Bitmap(MITesDataCollection.Resource1.Card));
        ...
        public FolderBrowserForm(PathInterface c)
        {
            this.c=c;
            //
            // TODO: Add constructor logic here
