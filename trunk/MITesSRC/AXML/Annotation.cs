...
namespace AXML
{
    public class Annotation
    {
        ...
        public const string DEFAULT_OUTPUT_FILE = "Annotation";
        public const string DEFAULT_OUTPUT_CSV_FILE = "Annotation";
        ...
        public Annotation()
        {
            ...
            this.output_file = DEFAULT_OUTPUT_FILE + fileSuffix + ".xml";
            this.output_csv_file = DEFAULT_OUTPUT_CSV_FILE + fileSuffix + ".csv";
        }
        ...
        public void ToCSVFile()
        {
            ...
            csv += Constants.STARTDATE_ATTRIBUTE + "," + Constants.STARTTIME_ATTRIBUTE + "," + Constants.ENDDATE_ATTRIBUTE + "," +
                Constants.ENDTIME_ATTRIBUTE;
            foreach (Category category in this.categories)
            {
                csv += "," + category.Name;
            }
