...
namespace weka.core.matrix
{
	...
	public class EigenvalueDecomposition
	{
		...
		/// <summary> helper variables for the comples scalar division</summary>
		/// <seealso cref="cdiv(double,double,double,double)">
		/// </seealso>
		[NonSerialized]
		private double cdivr, cdivi;
		
		/// <summary> Symmetric Householder reduction to tridiagonal form.
		/// <p/>
		...
		/// <summary> Symmetric tridiagonal QL algorithm.
		/// <p/>
		...
		/// <summary> Nonsymmetric reduction to Hessenberg form.
		/// <p/>
		...
		/// <summary> Complex scalar division.</summary>
		...
		/// <summary> Nonsymmetric reduction from Hessenberg to real Schur form.
		/// <p/>
		...
		/// <summary> Check for symmetry, then construct the eigenvalue decomposition
		/// 
		/// </summary>
