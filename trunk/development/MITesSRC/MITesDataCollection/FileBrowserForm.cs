//
// FileBrowserForm
// Underlying implementation of the FileBrowserDialog
...
namespace OpenNETCF.Windows.Forms
{
	...
	/// </summary>
	internal class FileBrowserForm : Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Text = "Browse for File";
            this.Resize += new System.EventHandler(this.FileBrowserDialog_Resize);
        ...
        /// <summary>
        /// Create a new instance of the FileBrowserDialog
        /// </summary>
        public FileBrowserForm()
        {
            ...
            ilIcons.Images.Add(MITesDataCollection.Resource1.Folder);
#if (PocketPC)
            ilIcons.Images.Add(MITesDataCollection.Resource1.Device);
#else
            ilIcons.Images.Add(MITesDataCollection.Resource1.PC);
#endif
            ilIcons.Images.Add(MITesDataCollection.Resource1.Card);
		...
		/// Create a new instance of the FileBrowserDialog
		/// </summary>
        public FileBrowserForm(PathInterface c)
		{
            this.c = c;
			//
			// TODO: Add constructor logic here
        ...
        void tvFolders_DoubleClick(object sender, EventArgs e)
        {
            //user made a selection return OK
            this.DialogResult = DialogResult.OK;
            if (this.c != null)
#if (PocketPC)               
                this.c.UpdateSelectedPath(this.m_selectedpath);
#else
                this.c.UpdateSelectedPath("C:" + this.m_selectedpath);
#endif
            this.Close();
        }
        ...
        private void InitializeInterface()
        {
            ...
            this.tvFolders.DoubleClick += new EventHandler(tvFolders_DoubleClick);
		...
		/// <param name="e"></param>
		private void FileBrowserDialog_Resize(object sender, System.EventArgs e)
		{
		...
		private void mnuDone_Click(object sender, System.EventArgs e)
		{
			//user made a selection return OK
			this.DialogResult = DialogResult.OK;           
            this.fileListDialog = new FileListDialog(this.c);
            this.fileListDialog.FilePath = this.m_selectedpath;
            this.fileListDialog.RefreshList();
            this.fileListDialog.Show();
            //this.fileListDialog.FilePath = this.m_selectedpath;
           // this.fileListDialog.RefreshList();
            //this.fileListDialog.Show();
            //this.m_selectedfile = this.fileListDialog.FileName;
