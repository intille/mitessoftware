namespace MITesDataCollection
{
    partial class SimilarActivitiesForm
    {
        ...
        {
            this.label1.Text = "What is being confused the most with " + this.confusedActivity +":";
            int cindex=0;
            foreach (AXML.Label label in ((AXML.Category)this.aanotation.Categories[0]).Labels)
            {
                if (label.Name != this.confusedActivity)
                {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "What is being confused the most with activity X?";
            // 
